...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var wfreq = parseFloat(metadataResult.wfreq).toFixed(2);
    console.log(wfreq);
    ...
    //var yticks = sample_values.sort((a,b) => a-b).reverse().slice(0,10).map(function(x, i) {
      //return {
        //otu_ids: otu_ids[i],
    ...
    var yticks = otu_ids.slice(0,10).reverse().map(item => item = "OTU " + String(item));
    console.log(yticks);
